...
public class testCaseProfissionalSaude2 {
    ...
    public void testTestCaseProfissionalSaude2() throws Exception {
        ...
        // Warning: verifyTextPresent may require manual changes
        try {
            assertTrue("Dado que estou na página Lista de Adoloscentes e clico no botão 'Criar novo Adoloscente' e de seguida clico no botão 'Lista de Adoloscentes' então é suposto estar na página",driver.findElement(By.cssSelector("BODY")).getText().contains("Lista de Adolescentes"));
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
    }
